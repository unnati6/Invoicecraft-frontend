               ...
               <CardContent className="space-y-4">
                 {itemFields.map((field, index) => {
                   ...
                   <div key={field.id} className="space-y-3 p-3 border rounded-md relative">
                     ...
                     {itemFields.length > 1 && (
                       <Button type="button" variant="destructive" size="sm" onClick={() => removeItem(index)} className="absolute top-2 right-2">
               ...
               {chargeFields.map((field, index) => (
                 <div key={field.id} className="space-y-3 p-3 border rounded-md relative">
                   ...
                   {chargeFields.length > 0 && (
                     <Button type="button" variant="destructive" size="sm" onClick={() => removeCharge(index)} className="absolute top-2 right-2">
                       <Trash2 className="h-4 w-4 mr-2" /> Remove Charge
                     </Button>
                   )}
                 </div>
               ))}
